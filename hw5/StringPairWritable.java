...
public class StringPairWritable implements WritableComparable<StringPairWritable> {
   ...
   */
  /*
   * Each character in the string left and right is converted to a group of 
  one, two, or three bytes, depending on the value of 
  the character.
   */
   ...
   * string left and right are Unicode strings.
   */
...
/*
 * the parameter is another StringPairWritable object.
 * comparing the left string of existed StringPairWritable with another left string first,
 * if these two are equal, then compare the right string.
 * the return is the comparing result.
 */
